<?php
/* Smarty version 3.1.29, created on 2017-04-25 09:53:11
  from "C:\Users\Administrator\Desktop\git\personal\public\admin2\index.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58ff00678c93b3_60663369',
  'file_dependency' => 
  array (
    '3fcea52ec64dda49845988e9dce797143901fbbf' => 
    array (
      0 => 'C:\\Users\\Administrator\\Desktop\\git\\personal\\public\\admin2\\index.tpl',
      1 => 1493106789,
      2 => 'file',
    ),
  ),
...
function content_58ff00678c93b3_60663369 ($_smarty_tpl) {
?>
...
$__section_loop_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['admin']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_loop_0_total = $__section_loop_0_loop;
$_smarty_tpl->tpl_vars['__smarty_section_loop'] = new Smarty_Variable(array());
if ($__section_loop_0_total != 0) {
for ($__section_loop_0_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_loop']->value['index'] = 0; $__section_loop_0_iteration <= $__section_loop_0_total; $__section_loop_0_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_loop']->value['index']++){
?>
                                <span class="user-name"><?php echo $_smarty_tpl->tpl_vars['admin']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_loop']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_loop']->value['index'] : null)][1];?>
    ...
    <div class="page-sidebar sidebar horizontal-bar">
        <div class="page-sidebar-inner">
            <ul class="menu accordion-menu">
                ...
                <li class="active"><a href="admin_index.php"><span class="menu-icon icon-speedometer"></span><p>Dashboard</p></a></li>
                ...
                <li class="droplink"><a href="#"><span class="menu-icon icon-user"></span><p>Login</p><span class="arrow"></span></a>
                    <ul class="sub-menu">
                        <li><a href="admin_login.html">Login Form</a></li>
            ...
            <div class="row">
                    ...
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter"><?php echo $_smarty_tpl->tpl_vars['user_totalnumber']->value;?>
</p>
                                <span class="info-box-title">用户注册量</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter"><?php echo $_smarty_tpl->tpl_vars['view_number']->value;?>
</p>
                                <span class="info-box-title">浏览量</span>
                            </div>
                            <div class="info-box-icon">
                                <i class="icon-eye"></i>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p>$<span class="counter"><?php echo $_smarty_tpl->tpl_vars['feedback']->value;?>
</span></p>
                                <span class="info-box-title">用户评论量</span>
                            </div>
                            <div class="info-box-icon">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter"><?php echo $_smarty_tpl->tpl_vars['article']->value;?>
</p>
                                <span class="info-box-title">发文量</span>
                            </div>
                            <div class="info-box-icon">
                                <i class="icon-note"></i>
                            </div>
                    ...
                    <div class="panel panel-white" style="height: 100%;">
                        <div class="panel-heading">
                            ...
                            <div class="panel-control">
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="下拉/收起" class="panel-collapse"><i class="icon-arrow-down"></i></a>
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="刷新" class="panel-reload"><i class="icon-reload"></i></a>
                            </div>
                        </div>
                        <div class="panel-body">
...
>
<?php echo '<script'; ?>
 src="assets/plugins/waypoints/jquery.waypoints.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/jquery-counterup/jquery.counterup.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/toastr/toastr.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/flot/jquery.flot.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/flot/jquery.flot.time.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/flot/jquery.flot.symbol.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/flot/jquery.flot.resize.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/flot/jquery.flot.tooltip.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/curvedlines/curvedLines.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/plugins/metrojs/MetroJs.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/modern.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/pages/dashboard.js"><?php echo '</script'; ?>
>
