...
class Topic_M extends CI_Model {
    ...
    public function replace($ppattern,$replace,$tid)
    {
        return $this->db->query("update letsbbs_topic set content=replace(content,'".$ppattern."','".$replace."') where tid=$tid");
