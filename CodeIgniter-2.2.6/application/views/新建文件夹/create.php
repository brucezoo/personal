...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="C:/xampp/htdocs/bootstrap.min.css" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="C:/xampp/htdocs/clean-blog.min.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="C:/xampp/htdocs/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<header class="intro-header" style="background-image: url('C:/Users/Administrator/Desktop/zf/startbootstrap-clean-blog-1.1.0/img/home-bg.jpg')">

    <div class="container">
        <{if isset($smarty.session.valid_user)}>
        <a href="personnel_blog.php"title="用户中心"><img align="right" class='margin' src="./uploads/<{$head_image}>" ></a>
...
<script src="C:/xampp/htdocs/jquery.min.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="C:/xampp/htdocs/bootstrap.min.js"></script>

<!-- Contact Form JavaScript -->
<script src="C:/xampp/htdocs/jqBootstrapValidation.js"></script>
<script src="C:/xampp/htdocs/contact_me.js"></script>

<!-- Theme JavaScript -->
<script src="C:/xampp/htdocs/clean-blog.min.js"></script>
</body>
