    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-2">
            <div class="post-preview">
                ...
                <h2 align='center'><a class='m' href='http://localhost/index.php/blog/view/<?php echo $articles_item['id']?>' style='text-decoration: none'
                                      target='_blank'><?=$articles_item["title"]?></a><br /></h2>
                <p align='center' class=\"post-meta\">Posted by <a class='m' href='http://localhost/index.php/blog/view/<?php echo $articles_item['id'] ?>'
                                                                   style='text-decoration: none' target='_blank'><?=$articles_item["author"]?></a> on <?=$articles_item["articledate"]?><br /></p>
                <hr>
                <?php endforeach;?>
                <!-- Pager -->
                <ul class="pager">
